    ...
    private static void LoadCoreTalents(int level)
    {
        List<Talent> characteristicTalents = new()
        {
            ...
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("General - Sailor", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
    ...
    private static void LoadRangerTalents(int level)
    {
        List<Talent> hunterTalents = new()
        {
            ...
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("General - Treasure Hunter", "Cooldown", 25f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
            ...
            new()
            {
                ...
                m_level = level,
                m_type = TalentType.Finder,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Ranger - Hunter", "Cooldown", 25f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
            ...
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("Ranger - Trapped", "Cooldown", 10f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001f))),
                m_skill = Skills.SkillType.Bows
            }
        };
    ...
    private static void LoadSageTalents(int level)
    {
        List<Talent> sageTalents = new()
        {
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("Sage - Call of Lightning", "Cooldown", 20f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_talentDamages = new()
                {
            ...
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("Sage - Meteor Strike", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_talentDamages = new()
                {
            ...
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("Sage - Boulder Stroke", "Cooldown", 10f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
            ...
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("Sage - Goblin Beam", "Cooldown", 25f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_talentDamages = new()
                {
            ...
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("Sage - Ice Breath", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
    ...
    private static void LoadShamanTalents(int level)
    {
        List<Talent> shamanTalents = new()
        {
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("Shaman - Heal", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_isAbility = true,
            ...
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("Shaman - Protection", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_isAbility = true,
            ...
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("Shaman - Regeneration", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_isAbility = true,
            ...
            new()
            {
                ...
                m_ttl = AlmanacClassesPlugin._Plugin.config("Shaman - Ghastly Ambitions", "Cooldown", 30f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_skill = Skills.SkillType.BloodMagic
            },
            new()
            {
                ...
                m_skill = Skills.SkillType.ElementalMagic,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Shaman - Rooting", "Cooldown", 10f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_animation = "roar"
            },
            new()
            {
    ...
    private static void LoadBardTalents(int level)
    {
        List<Talent> bardTalents = new()
        {
            new ()
            {
                ...
                m_isAbility = true,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Bard - Song of Damage", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_skill = Skills.SkillType.ElementalMagic,
            ...
            new ()
            {
                ...
                m_isAbility = true,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Bard - Song of Healing", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_skill = Skills.SkillType.BloodMagic,
            ...
            new ()
            {
                ...
                m_cost = 3,
                m_isAbility = true,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Bard - Song of Vitality", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
            ...
            new()
            {
                ...
                m_isAbility = true,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Bard - Song of Speed", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_skill = Skills.SkillType.BloodMagic,
            ...
            new()
            {
                ...
                m_cost = 5,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Bard - Song of Spirit", "Cooldown", 25f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_skill = Skills.SkillType.ElementalMagic,
    ...
    private static void LoadRogueTalents(int level)
    {
        List<Talent> rogueTalents = new()
        {
            new ()
            {
                ...
                m_isAbility = true,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Rogue - Quick Step", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
            ...
            new ()
            {
                ...
                m_isAbility = true,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Rogue - Relentless", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_skill = Skills.SkillType.BloodMagic,
            ...
            new ()
            {
                ...
                m_isAbility = true,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Rogue - Retaliation", "Cooldown", 75f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_skill = Skills.SkillType.BloodMagic,
            ...
            new ()
            {
                ...
                m_isAbility = true,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Rogue - Backstabbing", "Cooldown", 20f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_skill = Skills.SkillType.Knives,
    ...
    private static void LoadWarriorTalents(int level)
    {
        List<Talent> warriorTalents = new()
        {
            new ()
            {
                ...
                m_isAbility = true,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Warrior - Hard Hitter", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
            ...
            new ()
            {
                ...
                m_isAbility = true,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Warrior - Bulk Up", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_skill = Skills.SkillType.BloodMagic,
            ...
            new ()
            {
                ...
                m_isAbility = true,
                m_ttl = AlmanacClassesPlugin._Plugin.config("Warrior - Resistance", "Cooldown", 50f, new ConfigDescription("Set cooldown", new AcceptableValueRange<float>(0, 1001))),
                m_skill = Skills.SkillType.BloodMagic,
